...
useEffect(() => {
    ...
    const textSplit = SplitText.create(".aboutpara", { type: "words, chars", wordsClass: "word" });
            ...
            <div className="border border-black p-4 max-w-[1000px] w-full">
                <div className="flex flex-col md:flex-row gap-4 min-h-[600px]">
                    <div className="flex-1 flex items-start">
                        <p className="aboutpara text-[min(8vw,2.8rem)] leading-[min(8vw,3.1rem)] font-['Outfit'] text-theme-color">
